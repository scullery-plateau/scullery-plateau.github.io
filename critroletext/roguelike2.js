(function(){
  window.RogueLikeMap = function(ui,config) {
    ...
    var draw = function() {
      ...
      var sprites = {};
      sprites = config.party.reduce(function(out,member,index){
        out[member.loc] = (index + 1) + "";
        return out;
      },sprites);
      sprites = config.foes.reduce(function(out,member,index){
    ...
    this.applyNearestOpenAdjacent = function(origin,targets) {
