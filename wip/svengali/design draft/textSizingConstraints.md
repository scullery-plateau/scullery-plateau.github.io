...
When the user creates a text layer, we will need to provide them certain constraints to prevent the layer from being too small or from overflowing the card.
