namespace('sp.texturePackHarvester.TexturePackHarvester',{
  ...
  return class extends React.Component {
    ...
    render() {
      return <>
        <Header menuItems={this.menuItems} appTitle={'Texture Pack Harvester'} />
        <div className="d-flex flex-column justify-content-center">
          { !this.state.baseImg && <>
            <p>Click the button below to choose an image to split into 1x1 tiles and tool will help to divide the image up into those tiles.</p>
            <button className="btn btn-success text-center" onClick={() => this.loadTexturePackImage()}>Load Texture Pack Image</button>
          </> }
          { this.state.baseImg &&
            <>
