namespace('sp.minifier.PrintMinis', { 
  ...
  'sp.common.Utilities':'util'
    ...
    const miniFrames = {
      1: {
        ...
        svg: [
          ...
          ['image', 0, 0, 8, 12, ['matrix', 0, 1, 1, 0, 21, 1]],
        ],
      },
      2: {
        rows: 5,
        ...
        svg: [
          ...
          ['image', 0, 0, 18, 27, ['matrix', 0, 1, 1, 0, 42, 1]],
        ],
      },
      3: {
        rows: 3,
        ...
        svg: [
          ...
          ['image', 0, 0, 26, 26, ['matrix', 0, 1, 1, 0, 42, 2]],
        ],
      },
      4: {
        rows: 1,
        ...
        svg: [
          ...
          ['rect', 1, 15, 38, 35],
          ['rect', 1, 50, 38, 35],
          ['image', 0, 0, 36, 31.5, ['matrix', 1, 0, 0, -1, 2, 48]],
    ...
    const printMiniPages = function (title, size, minisList) {
      const files = minisList.reduce((out, {mini}) => {
        out[mini.filename] = mini.canvasURL;
        return out;
      }, {});
      const minis = minisList.reduce((out, m) => {
        const step = Array(mini.count).fill(mini.filename);
